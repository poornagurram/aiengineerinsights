---
title: Google's A2A: Engineering Notes
date: '2025-05-11'
tags: ['A2A', 'Agents']
draft: false
summary: Deep dive into design choices behind google's A2A protocol
---
...
<Image
  src="/static/images/a2a_demo_arch.png"
  alt="A2A Demo Architecture"
  width={1200}
  height={600}
  className="w-full"
/>
